...
variable "runtime" {
  ...
  validation {
    condition     = contains(["nodejs22.x", "nodejs20.x", "nodejs18.x", "nodejs16.x", "python3.13", "python3.12", "python3.11", "python3.10", "python3.9", "java21", "java17", "go1.x", "dotnet8", "dotnet6", "ruby3.3", "ruby3.2", "provided.al2", "provided.al2023"], var.runtime)
